...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	const FOOTER_WIDGET_SLUG   = 'footer-widgets';
	...
	public function is_footer_widgets_active() : bool {
		return (bool) is_active_sidebar( static::FOOTER_WIDGET_SLUG );
	}
	...
	public function display_footer_widgets() {
		dynamic_sidebar( static::FOOTER_WIDGET_SLUG );
	}
}
